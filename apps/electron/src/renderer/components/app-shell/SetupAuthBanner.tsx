...
export function SetupAuthBanner({
  ...
  const getTitle = () => {
    switch (state) {
      case 'mcp_auth':
        return t('setupBanner.connectionRequired')
      case 'api_auth':
        return t('setupBanner.apiCredentialsRequired')
      case 'error':
  ...
  const getDescription = () => {
    ...
    switch (state) {
      case 'mcp_auth':
        return t('setupBanner.connectToServices')
      case 'api_auth':
        return t('setupBanner.enterApiCredentials')
      case 'error':
        return t('setupBanner.tapToRetry')
      default:
        return ''
    }
  }
  ...
  const getButtonText = () => {
    switch (state) {
      case 'mcp_auth':
        return t('setupBanner.connect')
      case 'api_auth':
        return t('setupBanner.addCredentials')
      case 'error':
        return t('setupBanner.retry')
      default:
