...
const HINT_TEMPLATES = [
  'Summarize your {source:Gmail} inbox, draft replies, and save notes to {source:Google Docs}',
  ...
  'Review {source:GitHub} PRs, then summarize changes in {source:Confluence}',
