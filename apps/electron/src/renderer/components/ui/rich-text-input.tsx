...
export const RichTextInput = React.forwardRef<RichTextInputHandle, RichTextInputProps>(
  function RichTextInput(
    ...
    React.useEffect(() => {
      ...
      lastMentionSignatureRef.current = getMentionSignature(value, skillSlugs)

      const html = textToHTML(value, skills, workspaceId)
    ...
    }, [value, skills, skillSlugs, workspaceId])
    ...
    // Show placeholder when input is empty and not composing (IME)
    const showPlaceholder = !value && !isComposingState
