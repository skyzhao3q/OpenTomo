 ...
 * - Location: Default (~/.opentomo/workspaces/) or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  const defaultBasePath = homeDir ? `${homeDir}/.opentomo/workspaces` : '~/.opentomo/workspaces'
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle="under .opentomo folder"
          />
