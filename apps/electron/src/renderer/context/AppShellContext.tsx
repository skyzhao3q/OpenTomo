...
export interface AppShellContextType {
  ...
  /** Current selected provider (opentomo, anthropic, custom) */
  provider: string
  currentModel: string
  ...
  customConnectionModels: { best?: string; balanced?: string; fast?: string } | null
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@opentomo/core').ContentBadge[]) => void
