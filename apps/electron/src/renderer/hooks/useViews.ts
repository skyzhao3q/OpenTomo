...
import type { ViewConfig, CompiledView, ViewEvaluationContext } from '@opentomo/shared/views'
import { compileAllViews, evaluateViews, buildViewContext } from '@opentomo/shared/views'
...
export function useViews(workspaceId: string | null): UseViewsResult {
  ...
  // Views changes could be added here if needed in the future
