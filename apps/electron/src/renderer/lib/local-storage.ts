...
export const KEYS = {
  ...
  artifactPanelTreeWidth: 'artifact-tree-width', // number px
  artifactMdMode: 'artifact-md-mode',           // 'preview' | 'code'
  explorerShowHidden: 'explorer-show-hidden',   // boolean — show/hide dotfiles in Explorer tab
} as const
