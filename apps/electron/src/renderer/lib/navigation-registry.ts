 ...
 */
export type NavigatorType = 'chats' | 'settings'

/**
 * Chat filter kinds that map to sidebar routes
 */
export type ChatFilterKind = 'allChats'
...
export const NavigationRegistry = {
  ...
  settings: {
    ...
    detailsPages: {
      ...
      providers: PlaceholderComponent, // ProvidersSettingsPage
    },
 ...
 */
export type AnyDetailsType = DetailsType<'chats'> | DetailsType<'settings'>
