 ...
 * Shows both default patterns (from ~/.opentomo/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.opentomo/permissions/default.json.
...
import { type PermissionsConfigFile } from '@opentomo/shared/agent/modes'
import {
...
import { getDocUrl } from '@opentomo/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.opentomo/permissions/default.json.
...
export default function PermissionsSettingsPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('permissionsSettings.title')} actions={<HeaderMenu route={routes.view.settings('permissions')} helpFeature="permissions" />} />
          ...
          <div className="px-5 py-7 max-w-3xl mx-auto">
            <div className="space-y-8">
              {isLoading ? (
                ...
                <>
                  {/* About Section */}
                  <SettingsSection title={t('permissionsSettings.aboutPermissions')}>
                    <SettingsCard className="px-4 py-3.5">
                      <div className="text-sm text-muted-foreground leading-relaxed space-y-1.5">
                        <p>
                          {t('permissionsSettings.aboutPermissionsP1', { explore: t('permissionsSettings.aboutPermissionsP1explore'), execute: t('permissionsSettings.aboutPermissionsP1execute') })}
                        </p>
                        <p>
                          {t('permissionsSettings.aboutPermissionsP2')}
                        </p>
                        <p>
                          <button
                            type="button"
                  ...
                  <SettingsSection
                    ...
                    description={t('permissionsSettings.defaultPermissionsDesc')}
                    action={
                      ...
                      {defaultPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          ...
                          <p className="text-xs mt-1 text-foreground/40">
                            {t('permissionsSettings.noDefaultPermissionsHint')}
                          </p>
                        </div>
                      )}
                    </SettingsCard>
                  ...
                  <SettingsSection
                    ...
                    description={t('permissionsSettings.workspaceCustomizationsDesc')}
                    action={
                      (() => {
                    ...
                    <SettingsCard className="p-0">
                      {customPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          ...
                          <p className="text-xs mt-1 text-foreground/40">
                            {t('permissionsSettings.noCustomPermissionsHint')}
                          </p>
                        </div>
                      )}
                    </SettingsCard>
