...
import { TurnCard, type ActivityItem } from '@opentomo/ui'
  ...
  return (
    <div className="w-full max-w-[960px] h-full flex flex-col">
      ...
      <div className="mx-auto w-full px-4 pb-4 mt-1" style={{ maxWidth: 'var(--content-max-width, 960px)' }}>
        ...
        {/* Real InputContainer */}
        <InputContainer
          placeholder="Message OpenTomo..."
          disabled={false}
          isProcessing={false}
          currentModel="claude-sonnet-4-5-20250929"
          permissionMode={permissionMode}
          onPermissionModeChange={setPermissionMode}
          workingDirectory="/Users/demo/projects/opentomo"
          sessionId="playground-session"
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/opentomo',
      },
    ],
    mockData: () => {
