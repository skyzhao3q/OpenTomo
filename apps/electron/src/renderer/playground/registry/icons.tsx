...
import { OpenTomoLogo } from '@/components/icons/OpenTomoLogo'
...
export const iconComponents: ComponentEntry[] = [
  {
    ...
    name: 'OpenTomoLogo',
    category: 'Icons',
    description: 'Full OpenTomo branding logo with text',
    component: OpenTomoLogo,
    props: [
      {
        name: 'className',
  ...
  },
  {
    ...
    name: 'OpenTomoSymbol',
    category: 'Icons',
    description: 'OpenTomo "E" pixel art symbol icon (brand color: #9570BE)',
    component: OpenTomoSymbol,
    props: [
      {
        name: 'className',
