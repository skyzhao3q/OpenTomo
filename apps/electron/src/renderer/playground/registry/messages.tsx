...
// Uses shared components from @opentomo/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @opentomo/ui) */}
      <section>
...
function createAuthMessage(opts: {
  type: 'credential' | 'oauth' | 'oauth-google'
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @opentomo/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @opentomo/ui)',
