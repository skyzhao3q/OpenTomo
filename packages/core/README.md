...
Shared TypeScript types and utilities for opentomo applications.

## Installation

```bash
# In a workspace package
bun add @opentomo/core
```
...
// Import utilities
import { generateMessageId, debug } from '@opentomo/core';
```
...
- `McpAuthType` - Auth method: `workspace_bearer` | `public`
...
- `AgentEvent` - Events from opentomoAgent
