 ...
 *
 * File locations:
 * - Workspace: ~/.opentomo/workspaces/{slug}/permissions.json
 * - Per-source: ~/.opentomo/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.opentomo/permissions/
 */
...
/**
 * Load default permissions from ~/.opentomo/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.opentomo/permissions/default.json)
   ...
   * These come from ~/.opentomo/permissions/default.json
   */
