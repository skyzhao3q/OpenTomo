 ...
 * Guides are now served exclusively via the opentomo-docs MCP server.
 *
 ...
 * Use the opentomo-docs MCP server to search for setup guides.
 *
 * Example: mcp__opentomo-docs__SearchOpenTomo({ query: "github source setup guide" })
 */
