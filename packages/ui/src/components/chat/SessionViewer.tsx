...
import type { StoredSession } from '@opentomo/core'
...
/**
 * OpenTomoAgentLogo - The OpenTomo logo for branding
 */
function OpenTomoAgentLogo({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
        ...
        >
          <div className="h-full overflow-y-auto">
            ...
            <div className={CHAT_CLASSES.brandingContainer}>
              <OpenTomoAgentLogo className="w-8 h-8 text-[#9570BE]/40" />
            </div>
            </div>
          </div>
        </div>
